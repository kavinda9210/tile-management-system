        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li><a href="../homepage/index.php"> &nbsp; <span class='glyphicon glyphicon-home'></span> Home</a></li>
...
include("config.php");
	...
	if($stmt->rowCount() > 0)
	{
        ...
        <a href='../homepage/admin/print.php?pid=" . $user_id . "' class='btn btn-primary' id='print-link'>
