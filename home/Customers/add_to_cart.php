...
<body>
 ...
 <form role="form" method="post" action="save_order.php">
    ...
    <tr>
        ...
        <td>
        	<p><img class="img img-thumbnail" src="../../admin/admin/itempic/<?php echo $item_image; ?>" style="height:250px;width:350px;" /></p>
         ...
         <td>
        <?php 
        if (isset($qty) && $qty == 0):  // Use 'qty' instead of 'item_qty'
        ?>
        ...
        ?>
            <span style="color: red;">Error: Item quantity not available</span>
        <?php 
        endif;
        ?>
    </td>
