	...
	<div id="wrapper">
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.php">Herath Tile Show Room</a>
			</div>
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav side-nav">
					<li><a href="../homepage/index.php"> &nbsp; <span class='glyphicon glyphicon-home'></span> Home</a>
					</li>
					<li class="active"><a href="shop.php?id=1"> &nbsp; <span
								class='glyphicon glyphicon-shopping-cart'></span> Shop Now</a></li>
				...
				<ul class="nav navbar-nav navbar-right navbar-user">
					...
					<li class="dropdown user-dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span
								class='glyphicon glyphicon-shopping-cart'></span> Total Price Ordered: LKR
							<?php echo $total; ?> </b>
						</a>
					...
					<li class="dropdown user-dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i>
							<?php echo $user_email; ?><b class="caret"></b>
						</a>
		...
		<div id="page-wrapper">
			...
			<div class="alert alert-default" style="color:white;background-color:#0f2453">
				<center>
					<h3> <span class="glyphicon glyphicon-shopping-cart"></span> This is our Tile Stock, Shop now!</h3>
				</center>
			</div>
...
while ($query2 = mysqli_fetch_array($query)) {
    ...
    if (!file_exists($imagePath)) {
        $imageTag = "<p style='color:red;'>Image not found</p>";
    } else {
        $imageTag = "<img src='$imagePath' class='img img-thumbnail' style='width:350px;height:150px;' />";
    }

    echo "<div class='col-sm-3'>
            <div class='panel panel-default' style='border-color:#008CBA;'>
                <div class='panel-heading' style='color:white;background-color : #0f2453;'>
                    <center> 
                ...
                <div class='panel-body'>
                    ...
                    <center><h4> Price: LKR ".$query2['item_price']." </h4></center>
                    <a class='btn btn-block btn-danger' href='add_to_cart.php?cart=".$query2['item_id']."'>
...
if($id>1)
{
	echo "<li><a style='color:white;background-color : #0f2453;' href='?id=".($id-1)."'>Previous Page</a><li>";
}
if($id!=$total)
{
	echo "<li><a style='color:white;background-color :#0f2453 ;' href='?id=".($id+1)."' class='pager'>Next Page</a></li>";
}
echo "</ul>";
...
echo "<center><ul class='pagination pagination-lg'>";
		for($i=1;$i<=$total;$i++)
		{
			if($i==$id) { echo "<li class='pagination active'><a style='color:white;background-color : #0f2453;'>".$i."</a></li>"; }
...
?>
			...
			<div class="alert alert-default" style="background-color:#0f2453;">
				<p style="color:white;text-align:center;">
					&copy 2023 HERATH TILE SHOW ROOM | All Rights Reserved | Design by : Webwired Team
