...
<head>
  ...
  <title>  Herath Tile Shop  | Edit User Details</title>
...
$query=mysqli_query($con,"select CONCAT(user_firstname,' ',user_lastname) AS fullname, user_email, user_address from users where user_id='$cid'");
$cnt=1;
