...
<!--  Full Name--->
   <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="item_name" name="item_name" placeholder="Enter Item  Name" value="<?php echo $result['item_name']?>" required>
                  </div>
<!--   Email---->
                  <div class="form-group">
                    <label for="exampleInputEmail1">Item Price</label>
                    <input type="text" class="form-control" id="item_price" name="item_price" value="<?php echo $result['item_price']?>" placeholder="Enter Item Price" required>
                  </div>
<!--Number---->
                  <div class="form-group">
                    <label for="text">Item Quantity</label>
                    <input type="text" class="form-control" id="qty" name="qty" placeholder="Enter Item Quantity"  value="<?php echo $result['qty']?>" required>
                  </div>
...
<!--Subject---->
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="item_date" value="<?php echo $result['item_date']?>" name="item_date" placeholder="Enter Item Added Date"  required>
                  </div>
  ...
  <div class="form-group">
               ...
               <img src="itempic/<?php echo $result['item_image']?>" width="120">
               <a href="update-teacher-pic.php?tid=<?php echo $result['item_id'];?>">Update Item Image</a>
                  </div>
